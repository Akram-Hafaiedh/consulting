<aside>
    ...
    <div class="dashboard-nav">
        <header><a href="#!" class="menu-toggle"><i class="fas fa-bars"></i></a><a href="#" class="brand-logo"><i
                class="fas fa-anchor"></i> <span>QUIZIT</span></a></header>
        <nav class="dashboard-nav-list">
            <a
                href="/dashboardadmin" class="dashboard-nav-item active"><i class="fas fa-tachometer-alt"></i> dashboard
        </a>
        @if(Auth::user()->role_id==1)
         <a href="/quizs" class="dashboard-nav-item"><i class="fas fa-file-upload"></i> Quiz </a>
        @else
        <a href="/quizsconseiller" class="dashboard-nav-item"><i class="fas fa-file-upload"></i> Quiz </a>

        @endif


        @if (Auth::user()->role_id== '2')
        <a href="/questions" class="dashboard-nav-item"><i class="fas fa-file-upload"></i> Questions </a>
         @endif
          ...
          <form action="{{ route('logout') }}" method="post" style="display: inline;">
            @csrf
            <a href="{{ route('logout') }}" onclick="event.preventDefault(); this.closest('form').submit();" class="dashboard-nav-item">Logout</a>
        </form>
