...
@section('content')
    <div class="container px-4 py-12 mx-auto">
        <div class="mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8">
                <h2 class="mb-4 text-xl font-semibold text-gray-900">Modification d'un FAQ</h2>
                    ...
                    <form action="{{ route('faqs.update', $faq) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="answer" id="answer"
                                class="w-full px-3 py-2 leading-tight text-gray-700 border rounded shadow appearance-none focus:outline-none focus:shadow-outline">{{ $faq->answer }}</textarea>
                        </div>

                        <div class="flex items-center justify-end">
                            <button
                                class="px-4 py-2 font-bold text-white bg-blue-500 rounded hover:bg-blue-700 focus:outline-none"
                                type="submit">Modifier FAQ</button>
                        </div>
                    </form>
                </div>
            </div>
