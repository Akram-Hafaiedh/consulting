            ...
            <div class="mt-8 overflow-hidden bg-white shadow-xl sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="flex justify-between">
                        <h1 class="text-2xl font-semibold text-gray-900">Create New Quiz</h1>
                    ...
                    <div class="pb-4 bg-white border-b border-gray-200 ">
                        <form method="POST" action="{{ route('conseiller.quizzes.store') }}">
                            @csrf
                            <div class="mt-4">
                                            ...
                                            <div class="flex mt-2">
                                                <input type="text"
                                                    ...
                                                    :name="'questions[' + questionIndex + '][options][' + optionIndex +
                                                        '][text]'"
                                                    placeholder="Option text" required x-model="option.text">
